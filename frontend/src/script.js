...
document.addEventListener('DOMContentLoaded', function () {
    ...
    (function () {
        let showCatBtns = document.querySelectorAll('.show-cat-btn');

        if (showCatBtns) {
            showCatBtns.forEach(function (showCatBtn) {
                let catSubMenu = showCatBtn.nextElementSibling;
                showCatBtn.addEventListener('click', function (e) {
                    e.preventDefault();
                    catSubMenu.classList.toggle('visible');
                    let catBtnToRotate = document.querySelector('.category__btn');
    ...
    (function () {
        let showMenu = document.querySelector('.lang-switcher');
    ...
    (function () {
        let userDdBtnList = document.querySelectorAll('.dropdown-btn');
        let userDdList = document.querySelectorAll('.users-item-dropdown');
        let layer = document.querySelector('.layer');
    ...
    (function () {
        ...
        let checkers = document.querySelectorAll('.check');

        if (checkAll && checkers) {
            checkAll.addEventListener('change', function (e) {
                let _iterator6 = _createForOfIteratorHelper(checkers),
                    _step6;

                try {
                    for (_iterator6.s(); !(_step6 = _iterator6.n()).done;) {
                        let checker = _step6.value;
            ...
            let _iterator7 = _createForOfIteratorHelper(checkers),
                _step7;

            try {
                let _loop = function _loop() {
                    let checker = _step7.value;
                    checker.addEventListener('change', function (e) {
                        ...
                        let totalChecked = document.querySelectorAll('.users-table .check:checked');
    ...
    (function () {
        let checkAll = document.querySelector('.check-all');
        let checkers = document.querySelectorAll('.check');
        let checkedSum = document.querySelector('.checked-sum');
        ...
        if (checkedSum && checkAll && checkers) {
            ...
            let _iterator8 = _createForOfIteratorHelper(checkers),
                _step8;

            try {
                for (_iterator8.s(); !(_step8 = _iterator8.n()).done;) {
                    let checker = _step8.value;
                    checker.addEventListener('change', function (e) {
                        let totalChecked = document.querySelectorAll('.users-table .check:checked');
                        checkedSum.textContent = totalChecked.length;
                    });
